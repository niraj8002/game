...
const Fastparity = (props) => {
    ...
    const [BetPeriod, setBetPeriod] = useState(0);
    ...
    const getGameResult = () => {
        axiosInstance.get(`/fastparityResult`).then((res) => {
    ...
    const onConfirmBat = (e) => {
        ...
        if (walletData >= batAmount) {
            ...
            if (typeof (e) === "string") {
                ...
                axiosInstance.post('/fastParity', data).then((res) => {
        setBetPeriod(data.period)
                            ...
                            <div class="row" id="warea">
                                <div class="col-12 nav-top">
                                    <div class="row">
                                        ...
                                        <div class="col-8 tfw-5 tf-18 text-center">Fast-Parity</div>
                                    ...
                                    <div class="row tffm h264">
                                        ...
                                        <div class="col-12">
                                            <div class="row tf-16 mr-0" id="xrecd">
                                                <div class="col-8 mt-2 mb-2 pb-2 pl-0 xtl tf-18 tfcdb">Fast-Parity Record(s)</div>
